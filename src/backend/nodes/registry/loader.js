...
const requiredNodes = require('pagenodes-nodes/src/backend'); //require('../nodeDefs');
...
function load(defaultNodesDir, disableNodePathScan) {
  ...
  console.log('Loaded Nodes', PN.nodes.registry.nodeConstructors);
...
function loadNodeFiles(nodeFiles) {
  ...
  for (var module in nodeFiles) {
    ...
    if (nodeFiles.hasOwnProperty(module)) {
      if (nodeFiles[module].redVersion && !semver.satisfies(PN.version().replace("-git", ""), nodeFiles[module].redVersion)) {
        //TODO: log it
        continue;
      }
