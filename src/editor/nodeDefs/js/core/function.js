  ...
  RED.nodes.registerType('function',{
    ...
    render: function () {
      return (
        ...
        <label htmlFor="node-input-func"><i className="fa fa-wrench"></i> <span data-i18n="function.label.function"></span></label>
        <input type="hidden" id="node-input-func" autofocus="autofocus"/>
        <input type="hidden" id="node-input-noerr"/>
        </div>
        <div className="form-row node-text-editor-row">
        <div style="height: 250px;" className="node-text-editor" id="node-input-func-editor" ></div>
        </div>
        <div className="form-row">
        <label htmlFor="node-input-outputs"><i className="fa fa-random"></i> <span data-i18n="function.label.outputs"></span></label>
        <input id="node-input-outputs" style={{ width: "60px", height: "1.7em" }} value="1"/>
        </div>
        <div className="form-tips"><span data-i18n="function.tip"></span></div>
