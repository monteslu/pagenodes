module.exports = function(RED){
  RED.nodes.registerType('template',{
    ...
    render: function () {
      ...
      <label htmlFor="node-input-template"><i className="fa fa-file-code-o"></i> <span data-i18n="template.label.template"></span></label>
      <input type="hidden" id="node-input-template" autofocus="autofocus"/>
      <select id="node-input-format" style={{ fontSize: "0.8em", marginBottom: "0.8em", marginBottom: "3px", width: "110px", float: "right" }}>
      ...
      <div style={{ height: "250px" }} className="node-text-editor" id="node-input-template-editor" ></div>
      </div>
      <div className="form-row">
      <label htmlFor="node-input-field"><i className="fa fa-edit"></i> <span data-i18n="template.label.property"></span></label>
