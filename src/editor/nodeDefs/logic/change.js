    ...
    return (
      <div>
        ...
        <div className="form-row node-input-rule-container-row" style={{ marginBottom: "0px" }}>
          <div id="node-input-rule-container-div" style={{ boxSizing: "border-box", borderRadius: "5px", height: "300px", padding: "5p", border: "1px solid #ccc", overflowY: "scroll" }}>
            <ol id="node-input-rule-container" style={{ listStyleType: "none", margin: "0" }}></ol>
          </div>
        </div>
        <div className="form-row">
          <a href="#" className="editor-button editor-button-small" id="node-input-add-rule" style={{ marginTop: "4px" }}><i className="fa fa-plus"></i> <span data-i18n="change.label.rule"></span></a>
        </div>
      </div>
    )
  },
